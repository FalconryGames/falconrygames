document.addEventListener("DOMContentLoaded", function () {
    ...
    const tcgsDropdown = document.getElementById("tcgsDropdown");
    const miniatureDropdown = document.getElementById("miniatureDropdown");
    const rolePlayingDropdown = document.getElementById("rolePlayingDropdown");
    const boardGamesDropdown = document.getElementById("boardGamesDropdown");
    ...
    if (
      ...
      tcgsCheckbox.addEventListener("change", function () {
        tcgsDropdown.classList.toggle("hidden", !this.checked);
      });
  
      miniatureCheckbox.addEventListener("change", function () {
        miniatureDropdown.classList.toggle("hidden", !this.checked);
      });
  
      rolePlayingCheckbox.addEventListener("change", function () {
        rolePlayingDropdown.classList.toggle("hidden", !this.checked);
      });
  
      boardGamesCheckbox.addEventListener("change", function () {
        boardGamesDropdown.classList.toggle("hidden", !this.checked);
      });
    }
  });
